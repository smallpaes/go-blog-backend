...
var (
	...
	UnauthorizedTokenError    = NewError(10000003, "Auth Failed, token error")
	UnauthorizedTokenTimeout  = NewError(10000003, "Auth Failed, token timeout")
	UnauthorizedTokenGenerate = NewError(10000003, "Auth Failed, token generation failed")
